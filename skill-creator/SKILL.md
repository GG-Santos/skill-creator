---
name: skill-creator
description: Create and maintain Codex skills, including complex skills that need reusable blueprints, evaluation, ecosystem analysis, or release tooling. Use for authoring or materially improving SKILL.md-based skills and for explicit audits or comparisons of skill libraries. Do not use for ordinary software features or résumé “skills” unrelated to agent skills.
license: Apache-2.0
metadata:
...
| **Audit** | The user asks for review, comparison, safety, quality, or maintainability findings | [Reviewer](agents/reviewer.md) | Evidence-linked findings; no silent implementation unless requested |
...
6. unresolved limitations, untested claims, and release/provenance status.
