...
remains an external dependency. The reviewed baseline, contract tests, live
NVIDIA 2.11.2 safe and malicious-fixture runs, and compatibility limits are documented in
